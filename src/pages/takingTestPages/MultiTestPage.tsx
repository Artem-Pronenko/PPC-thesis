import React, {FC, FormEvent, LegacyRef, useContext, useEffect, useRef, useState} from 'react'
...
const TestForm: FC<formProps> = ({formRef, sendTest, responseTest, isSendTest, isChecked, slug}) => {
  return (
